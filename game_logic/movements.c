...
/*   Updated: 2023/12/07 11:42:17 by mbennani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_forward(t_scene *scene)
{
	if (scene->map->map[(int)(scene->player->pos[X])
		/ UNIT][(int)(scene->player->pos[Y] + scene->player->dir[Y]
			* scene->move_speed) / (UNIT)] != '1' && !does_it_collide(scene, 1))
		scene->player->pos[Y] += scene->player->dir[Y] * scene->move_speed;
	if (scene->map->map[(int)(scene->player->pos[X] + scene->player->dir[X]
...
{
	if (scene->map->map[(int)(scene->player->pos[X])
		/ UNIT][(int)(scene->player->pos[Y] - scene->player->plane[Y]
